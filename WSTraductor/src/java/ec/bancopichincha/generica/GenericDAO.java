...
public interface GenericDAO<T, ID extends Serializable> {
     ...
     */
    T findById(ID id, boolean lock, Session sesion);
     ...
     * búsqueda.
     */
    List<T> find(T entityExample, Session sesion, Boolean... maxRegistrosConsulta);
     ...
     * búsqueda.
     */
    Integer count(T entityExample, Session sesion);
     ...
     *
     */
    T insert(T entity, Session sesion);
     ...
     * datos.
     */
    T update(T entity, Session sesion);
     ...
     * @param sesion
     */
    void makeTransient(T entity, Session sesion);
     ...
     * @param sesion
     */
    void remove(T entity, Session sesion);
     ...
     */
    List<Object> ejecutarNativo(String sentencia, Session sesion) throws Exception;

    /**
     * Ejecutar actualización nativa.
     *
     * @param sentencia la sentencia
     * @param sesion
     * @return
     * @throws java.lang.Exception
     */
    int ejecutarUpdateNativo(String sentencia, Session sesion) throws Exception;
     ...
     */
    T bloquearEscritura(T entidad, Session sesion);
     ...
     * @param sesion
     */
    void refresh(T entidad, Session sesion);

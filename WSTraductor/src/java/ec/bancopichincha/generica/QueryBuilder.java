...
public class QueryBuilder<T> {
    ...
    public org.hibernate.Query buildQuery(Integer type, Session sesion, T example, String... orden) {
        StringBuilder qry;
...
//                                qry.append(idx);
        ...
        org.hibernate.Query query = sesion.createQuery(qry.substring(0, qry.length() - 2));
    ...
    private Map<String, Object> obtenerPropiedades(Object object, String... clave) {
        ...
        Map<String, Object> mapa = new HashMap<>(fields.length);
    ...
    private class Criterio {
         ...
         */
        private final Map<String, Object> igualdad = new HashMap<>();
        /**
         * Especifica las condiciones like.
         */
        private final Map<String, Object> like = new HashMap<>();
        /**
         * Especifica las condiciones con entidades compuestas.
         */
        private final Map<String, Object> compuesto = new HashMap<>();
        ...
        public void contruccion(Map<String, Object> propiedades) {
            ...
            for (String key : keys) {
                ...
                } else if (value.getClass().toString().startsWith("class java.time.LocalDate")
